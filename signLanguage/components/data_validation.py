...
from signLanguage.entity.artifact_entity import DataIngestionArtifacts, DataValidationArtifacts
...
class DataValidation:
    ...
    def validate_if_all_files_exist(self)-> bool:
        try:
    ...
    def initiate_data_validation(self)-> DataValidationArtifacts:
        ...
        try:
            ...
            logging.info("Entered initiate_data_validation method of DataValidation class.")
            logging.info(f"DataValidationArtifacts: {data_validation_artifact}.")
