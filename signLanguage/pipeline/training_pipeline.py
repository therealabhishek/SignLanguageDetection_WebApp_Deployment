...
from signLanguage.configuration.s3_operation import S3Operation
...
from signLanguage.entity.artifact_entity import DataIngestionArtifacts, DataValidationArtifacts, ModelTrainerArtifacts, ModelPusherArtifacts
...
class Trainpipeline:
    ...
    def start_model_pusher(self, model_trainer_artifact: ModelTrainerArtifacts, s3: S3Operation):
